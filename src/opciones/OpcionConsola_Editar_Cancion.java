...
public class OpcionConsola_Editar_Cancion extends Opcion {
	...
	private void edicion(Scanner input, ViewModelNota modelNota, ViewModelPista modelMelodia,
	 ...
	 * { ViewModelNota modelNota = new ViewModelNota(); String nombreNota =
	 * Funcion_Helper.pedirNombreNota(MENSAJE_NOMBRE_NOTA, input);
	 * modelNota.setNombre(nombreNota); String octava =
	 * Funcion_Helper.pedirOctava(MENSAJE_NUMERO_OCTAVA, input);
	 * modelNota.setOctava(octava); String figura =
	 * Funcion_Helper.pedirFigura(MENSAJE_NOMBRE_FIGURA, input);
	 * modelNota.setFigura(figura); String alteracion =
	 * Funcion_Helper.pedirAlteracion(MENSAJE_TIPO_ALTERACION, input);
	 * modelNota.setAlteracion(alteracion); modelNota.setId(contador.getValor());
	 * contador.incrementar(); notascompuestas.add(modelNota); }
	 */
	/*	
